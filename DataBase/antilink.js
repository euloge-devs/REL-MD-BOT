...
const relAntilink = sequelize.define('Antilink', {
  id: { type: DataTypes.STRING, primaryKey: true },
  mode: { type: DataTypes.STRING, defaultValue: "non" },
  type: { type: DataTypes.ENUM("supp", "warn", "kick"), defaultValue: "supp" }
}, {
  tableName: "antilink",
  timestamps: false
});
...
(async () => {
  await Antilink.sync();
  console.log("relAntilink synchronisée.");
  await Antilink_warnings.sync();
  console.log("relAntilink_warnings synchronisée.");
})();
